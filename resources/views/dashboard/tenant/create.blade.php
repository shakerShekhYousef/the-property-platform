...
@section('pageTitle', 'Create a new tenant')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('password_confirmation') is-invalid @enderror" id="validationCustom04"
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input type="tel" class="form-control @error('mobile_number') is-invalid @enderror" id="mobile_number"
                                                           ...
                                                           minlength="8" maxlength="13" value="+971"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input type="date" class="form-control @error('passport_expiry') is-invalid @enderror" id="passport_expiry"
                                        ...
                                        <div class="row" id="national_id_container">
                                            <div class="col-lg-6">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input type="file" accept="image/png, image/jpeg, image/png, image/gif" class="form-control" id="national_id_select" name="national_id_photo" required>
                                        ...
                                        <div class="row" id="passport_photo_container">
                                            <div class="col-lg-6">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input type="file" accept="image/png, image/jpeg, image/png, image/gif" class="form-control" id="passport_photo_select" name="passport_photo" required>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input type="file" class="form-control" id="visa_photo_select"
                                                           name="visa_photo" accept="image/png, image/jpeg, image/png, image/gif" required>
