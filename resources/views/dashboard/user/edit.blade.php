                    ...
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <div class="page-title">
                                <h4 class="mb-0 font-size-18">{{ __('sidebar.users.main') }}</h4>
                                <ol class="breadcrumb">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select name="role_id"
                                                            ...
                                                            {{-- <option disabled selected> readonly</option> --}}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input class="form-control @error('email') is-invalid @enderror"
                                                                ...
                                                                autocomplete="email" autofocus placeholder="Enter the Email"
                                                                required>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10 ">
                                                            <input type="text"
                                                                ...
                                                                name="phone_number" minlength="9" maxlength="13"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select name="language[]"
                                                                class="form-select select2-multiple @error('language') is-invalid @enderror select2"
                                                                aria-label="Default select example" id="language" multiple
                                                                required>
                                                                @foreach ($all_Languages as $item)
                                                                    <option value="{{ $item->id }}"
                                                                        @if ($user->Languages->containsStrict('id', $item->id)) selected="selected" @endif>
                                                                        {{ $item->name }}
                                                                    </option>
                                                                @endforeach
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <img src="{{ asset('storage/images/employees/image/' . $user->image) }}"
