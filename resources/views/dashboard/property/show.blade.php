...
@section('pageTitle', 'Show Property')
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <select name="landlord_id" class="form-control @error('landlord_id') is-invalid @enderror select2"
                                                            ...
                                                            readonly>
                                                        <option selected value="{{$property->landlord_id}}">{{$property->landlord->name}}</option>
                                                    </select>
                                                    @error('landlord')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <select name="payment_frequency_id" class="form-control @error('payment_frequency_id') is-invalid @enderror select2"
                                                            ...
                                                            readonly>
                                                        <option selected value="{{$property->payment_frequency_id}}">
                                                            {{$property->paymentFrequency->name}}
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3 form-group" style="display: none" id="tenant_input">
                                                    ...
                                                    <select name="tenant_id" class="form-control @error('tenant_id') is-invalid @enderror select2"
                                                            id="tenant_id"
                                                            readonly>
                                                        <option selected value="{{isset($property_tenant) ? $property_tenant->id : null}}">
                                                            {{isset($property_tenant) ? $property_tenant->name : null}}
                                                        </option>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <select name="property_type_id" class="form-control @error('property_type_id') is-invalid @enderror select2"
                                                            ...
                                                            readonly>
                                                        <option selected value="{{$property->PropertyType->id}}">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <select name="furniture_type_id" class="form-control @error('furniture_type_id') is-invalid @enderror select2"
                                                            ...
                                                            readonly>
                                                        <option selected value="{{$property->FurnitureType->id}}">{{$property->FurnitureType->name}}</option>
                                                    </select>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <select name="property_category_id" class="form-control @error('property_category_id') is-invalid @enderror select2"
                                                            ...
                                                            readonly>
                                                        <option selected value="{{$property->PropertyCategory->id}}">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <select name="property_status_id" class="form-control @error('property_status_id') is-invalid @enderror select2"
                                                            ...
                                                            readonly>
                                                        <option selected value="{{$property->PropertyStatus->id}}">
