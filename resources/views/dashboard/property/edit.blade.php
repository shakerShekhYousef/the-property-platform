                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control @error('p-number') is-invalid @enderror"
                                                           id="validationCustom03"
                                                           placeholder="{{__('labels.properties.p_number')}}"
                                                           name="p-number"
                                                           value="{{ $property["p-number"] }}"
                                                    >
                                                    @error('p-number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    ...
                                                    <select name="landlord_id" class="form-control @error('landlord_id') is-invalid @enderror select2"
                                                        ...
                                                        @foreach($landlords as $landlord)
                                                            @if($landlord->id == $property->landlord_id)
                                                                <option selected value="{{$landlord->id}}">{{$landlord->name}}</option>
                                                            @else
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <select name="payment_frequency_id" class="form-control @error('payment_frequency_id') is-invalid @enderror select2"
                                                        ...
                                                        @foreach($payments as $payment)
                                                            @if($payment->id == $property->payment_frequency_id)
                                            ...
                                            <div class="col-md-4" style="margin-top: 26px;">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked"
                                                           name="is_published"
                                                        {{$property->is_published == 1 ? "checked" :''}}
                                                    >
                                            ...
                                            <div class="col-md-4" style="margin-top: 26px;">
                                                <div class="form-check form-switch mb-4">
                                                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked1"
                                                        ...
                                                        {{$property->is_occupied == 1 ? "checked" :''}}
                                                    >
                                                ...
                                                <div class="mb-3 form-group" style="display: none" id="tenant_input">
                                                    ...
                                                    <select name="tenant_id" class="form-control @error('tenant_id') is-invalid @enderror select2"
                                                        ...
                                                        @foreach($tenants as $tenant)
                                                            @if($tenant->id == $property_tenant->id)
                                                                <option selected value="{{$tenant->id}}">{{$tenant->name}}</option>
                                                            @else
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <select name="furniture_type_id" class="form-control @error('furniture_type_id') is-invalid @enderror select2"
                                                        ...
                                                        @foreach($furnitureTypes as $type)
                                                            @if($type->id == $property->furniture_type_id)
                                                                <option selected value="{{$type->id}}">{{$type->name}}</option>
                                                            @else
                                                                <option value="{{$type->id}}">{{$type->name}}</option>
                                                            @endif
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <select name="property_category_id" class="form-control @error('property_category_id') is-invalid @enderror select2"
                                                        ...
                                                        @foreach($propertyCategories as $category)
                                                            @if($category->id == $property->property_category_id)
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <select name="amenity_id[]" class="form-control @error('amenity_id') is-invalid @enderror select2"
                                                        ...
                                                        @foreach($property->propertyAmenities as $propertyAmenity)
                                                            <option selected value="{{$propertyAmenity->id}}">{{$propertyAmenity->name}}</option>
                                                        @endforeach
                                                            ...
                                                            <div class="grid-img">
                                                                <div class="wrapper">
                                                                    <div class="file-upload-multi">
                                                                        <input name="inventory_images[]" id="files" type="file" multiple/>
                                                            ...
                                                            @if($inventoryImages)
                                                                @foreach($inventoryImages as $image)
                                                                    <div class="img-thumb-wrapper grid-img card shadow" style="width: 100%">
                                                                        <img class="img-thumb image-grid" src="{{asset('storage/'.$image->path)}}" title=""/>
                                                                        <span id="remove_inventory"
                                                                              data-id="{{$image->id}}"
                                                                              data-url="{{route('delete_inventory_images')}}"
                                                                              class="remove">
                                                    ...
                                                    <div class="row row-img">
                                                        <div class="div-grid-property" >
                                                            <div class="grid-img">
                                                                <div class="wrapper">
                                                                    <div class="file-upload-multi">
                                                                        <input name="property_images[]" id="files_property" type="file" multiple/>
                                                                        <i class="fa fa-plus"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            @if($property->propertyImages)
                                                                @foreach($property->propertyImages as $image)
                                                                    <div class="img-thumb-wrapper grid-img card shadow" style="width: 100%">
                                                                        <img class="img-thumb image-grid" src="{{asset('storage/'.$image->path)}}" title=""/>
                                                                        <span id="remove_property"
                                                                              data-id="{{$image->id}}"
                                                                              data-url="{{route('delete_property_images')}}"
                                                                              class="remove">
                                                                            <i class="fa fa-trash"></i>
                                                                        </span>
                                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <select  name="city_id"
                                                             ...
                                                             required
                                                    >
                                                        <option selected value="{{$property->city_id}}">{{$property->city->name}}</option>
                                                    </select>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3 form-group">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <!--our form-->
                                                        <input name="lat" value="{{$property->lat}}" type="text" id="lat" hidden ><br>
                                                        <input name="lng" value="{{$property->lng}}" type="text" id="lng" hidden >
                                                    </div>
                                                    @error('lat')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
...
@section('custom-script')
    ...
    <script type="text/javascript">
        window.onload = function () {
            var mapOptions = {
                center: new google.maps.LatLng({{$property->lat}},{{$property->lng}}),//which city will be shown.
                zoom: 7, //google map page zoom
                mapTypeId: google.maps.MapTypeId.ROADMAP //type of view.
            };
            var infoWindow = new google.maps.InfoWindow();
            var map = new google.maps.Map(document.getElementById("gmaps-markers"), mapOptions);//pass div id and google map load values.

            var myLatlng = new google.maps.LatLng({{$property->lat}},{{$property->lng}}); //here i assigned lat and long.
            ...
            google.maps.event.addListener(map, 'click', function(event) {
                ...
                var lat=document.getElementById('lat').value = clickedLocation.lat(); //latitude
                var long=document.getElementById('lng').value = clickedLocation.lng(); //longitude
            });
            //Listen for any clicks on the map. -->
            google.maps.event.addListener(map, 'click', function (event) {
                //Get the location that the user clicked. -->
    ...
    <script>
        $(document).ready(function (){
            var checkbox = $('#flexSwitchCheckChecked1');
            var input = $("#tenant_input");
